...
if __name__ == "__main__":
    ...
    CASES = [
        ...
        ("автоматизацию заказов давно пора делать", False, "ok"),
        ("у нас приёма заявок вообще нет как системы", False, "ok"),
        ("заявки терялись постоянно пока не навели порядок", False, "ok"),
        ("ищу бота для приема заказов от розницы", False, "ok"),
        ("может чат бот какой поставить", False, "ok"),
    ]
